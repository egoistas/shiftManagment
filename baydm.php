...
if (!isset($_SESSION['username']) || !in_array($_SESSION['role'], ['baydm'])) {
...
<script>
    ...
    function loadNames() {
        ...
        fetch(`get_names.php?postid=3&month=${formattedMonth}&year=${formattedYear}`)
