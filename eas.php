...
if (!isset($_SESSION['username']) || !in_array($_SESSION['role'], ['eas'])) {
...
<head>
    ...
    <title>Προγραμματισμός ΕΕΑΣ</title>
    <style>
       body {
...
<script>
    ...
    function loadNames() {
        ...
        fetch(`get_names.php?postid=1&month=${formattedMonth}&year=${formattedYear}`)
