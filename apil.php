...
if (!isset($_SESSION['username']) || !in_array($_SESSION['role'], ['apil'])) {
...
<div class="container">
    <h2>Προγραμματισμός Αξιωματικών Πύλης</h2>
...
<script>
    ...
    function loadNames() {
        ...
        fetch(`get_names.php?postid=4&month=${formattedMonth}&year=${formattedYear}`)
